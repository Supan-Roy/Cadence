...
function LibrarySidebar() {
  ...
  return (
    <aside className="h-full overflow-y-auto rounded-3xl border border-white/10 bg-[#0f1219]/85 p-5 shadow-[0_14px_36px_rgba(0,0,0,0.28)]">
      ...
      <section className="mt-5">
        ...
        <div className="rounded-xl border border-dashed border-white/15 bg-white/[0.03] p-5 text-base text-white/60">
          ...
          <div className="space-y-2">
            {playlists.map((playlist) => (
              <button
                ...
                className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2.5 text-left transition hover:bg-white/[0.08]"
              >
